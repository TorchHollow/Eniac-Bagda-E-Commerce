...
<body>
    ...
    <div class="container">
        ...
        <div class="cadastro">
            ...
            <a href="#">
                <img class="img-google-1" src="../assets/google.png" alt="">
            </a>

            <form class="form-cadastro" action="../back-end/cadastro.php" method="POST">
                ...
                <div class="form-group" style="position: relative;">
                    ...
                    <button type="button" id="toggleSenhaCadastro"
                        ...
                        <img id="iconSenhaCadastro" src="../assets/eye.png" alt="Mostrar senha" style="width:20px; height:20px;">
                    </button>
                </div>
        ...
        <div class="login">
            ...
            <a class="link-google-login" href="#">
                <img class="img-google-2" src="../assets/google.png" alt="">
            </a>

            <form class="form-cadastro" action="../back-end/login.php" method="post">
                ...
                <div class="form-group" style="position: relative;">
                    ...
                    <button type="button" id="toggleSenhaLogin"
                        style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%); background: none; border: none; cursor: pointer;">
                        <img id="iconSenhaLogin" src="../assets/eye.png" alt="Mostrar senha" style="width:20px; height:20px;">
                    </button>
                </div>
    ...
    <div class="recuperar-senha">
        ...
        <div class="img-email">
            <img src="../assets/Mail-amico.png" alt="">
        </div>
        ...
        <form class="form-recuperar-senha" action="../back-end/recuperar_senha.php" method="POST">
